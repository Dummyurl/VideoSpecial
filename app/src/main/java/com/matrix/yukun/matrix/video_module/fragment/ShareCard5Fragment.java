 ...
 * date:   On 2018/12/10
 */
public class ShareCard5Fragment extends BaseCardFragment {
    CardView mCardView;
    private String imageName="card_5.png";
    public static ShareCard5Fragment getInstance(){
        ShareCard5Fragment shareCard1Fragment=new ShareCard5Fragment();
        return shareCard1Fragment;
    }

    @Override
    public int getLayout() {
        return R.layout.card_share_5_fragment;
    }
