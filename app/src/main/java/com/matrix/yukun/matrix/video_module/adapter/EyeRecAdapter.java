        ...
        if(holder instanceof HeaderHolder){
            ...
            ((HeaderHolder) holder).mConBanner.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(int position) {
                    ...
                    intent.putExtra("video_path",list.get(position).getData().getPlayUrl());
                    intent.putExtra("video_cover",list.get(position).getData().getCover().getDetail());
                    intent.putExtra("video_title",list.get(position).getData().getTitle());
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(context, VideoPlayActivity.class);
                    intent.putExtra("video_path",eyesInfo.getData().getPlayUrl());
                    intent.putExtra("video_cover",eyesInfo.getData().getCover().getDetail());
                    intent.putExtra("video_title",eyesInfo.getData().getTitle());
                    intent.putExtra("type",1);//小视频界面要用
                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
